...
constexpr static int kNumClass = 2;  //todo  需要修改的地方
...
constexpr static int kInputH = 416;   //todo  需要修改的地方
constexpr static int kInputW = 864;   //todo  需要修改的地方
...
const static float kNmsThresh = 0.55f;   //todo  需要修改的地方
const static float kConfThresh = 0.55f;   //todo  需要修改的地方
