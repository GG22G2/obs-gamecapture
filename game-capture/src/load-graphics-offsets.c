...
char* obs_win_capture_path = "D:\\tools\\obs-studio\\data\\obs-plugins\\win-capture";


char* obs_module_get_config_path(char* module_config_path, const char* file)
{
	struct dstr output = { 0 };

	dstr_copy(&output, module_config_path);
	...
	const char* config_path)
{
	...
	offset_exe_path = obs_module_get_config_path(obs_win_capture_path, offset_exe.array);
